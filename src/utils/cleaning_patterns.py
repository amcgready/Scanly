patterns_to_remove = [
    # years
    r'\b(19|20)\d{2}\b',
    # Remove SxxE or SxE patterns (season/episode), including partials like S01E, S1E
    ...
    r'(?i)\b(DD5\.1|MA|MA5\.1|EAC3|GP|H264-FT|AV1|G66|LC|VC-1|LPCM|5 1|1 0|2 0|VO|DDP2\.0|FLAC1\.0|H-264|H-265|DDP5(\.\d)?|FLAC|AAC(\d(\.\d)?)?|AC3|DTS|TrueHD|Atmos|DV|1\.0|2\.0|5\.1|7\.1|10bit|8bit|opus|dual|audio)\b',
    # language patterns
